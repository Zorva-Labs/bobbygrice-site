...
export async function onRequest(context) {
  ...
  // bobbygrice.pages.dev serves the same HTML as bobbygrice.com. It must never be
...
<body><div class="card">
  ...
  <h1>Bobby G. Rice works in our fans.</h1>
  <p>This site isn't available in your region. If you are seeing this in error, get in touch and we will sort it out.</p>
